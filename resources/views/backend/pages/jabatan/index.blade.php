            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="float-right mb-2">
                        @if (Auth::guard('admin')->user()->can('jabatan.create'))
                            ...
                            <tbody>
                               ...
                               <tr>
                                    ...
                                    <td>
                                        ...
                                        @if (Auth::guard('admin')->user()->can('jabatan.delete'))
                                        <a class="btn btn-danger text-white" href="{{ route('admin.jabatans.destroy', $data->serial) }}"
                                        onclick="event.preventDefault(); document.getElementById('delete-form-{{ $data->serial }}').submit();">
                                            Delete
                                        </a>
                                        <form id="delete-form-{{ $data->serial }}" action="{{ route('admin.jabatans.destroy', $data->serial) }}" method="POST" style="display: none;">
                                            @method('DELETE')
                                            @csrf
                                        </form>
                                        @endif
